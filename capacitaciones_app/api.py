    ...
    data = [
        {
            ...
            "NumeroColaborador": encuesta.usuario.userprofile.numeroColaborador if encuesta.usuario and hasattr(encuesta.usuario, 'userprofile') and encuesta.usuario.userprofile.numeroColaborador else None,
