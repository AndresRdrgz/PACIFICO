#!/usr/bin/env python
"""
Script para configurar datos iniciales del Comité de Crédito
"""
...
def setup_comite():
    """
    Configura los datos iniciales del comité de crédito
    """
    
    # 1. Crear niveles de comité básicos
    print("🏗️  Configurando niveles de comité...")
    ...
    for pipeline in pipelines:
        etapa_comite, created = Etapa.objects.get_or_create(
            ...
            defaults={
                'orden': 50,  # Orden medio para que esté entre etapas
                'sla': '72:00:00',  # 72 horas de SLA
                'es_bandeja_grupal': True  # Importante para el comité
            }
        )
        if created:
    ...
    # 3. Asignar superusuario al nivel más alto (opcional)
